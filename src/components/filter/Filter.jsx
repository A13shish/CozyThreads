...
function Filter() {
    ...
    console.log("Search:", searchkey, "Category:", filterType, "Price:", filterPrice);
            ...
            <div className='container mx-auto px-4 mt-5'>
                <div className="p-5 rounded-lg bg-gray-100 drop-shadow-xl border border-gray-200"
                    ...
                    <div className="flex items-center justify-between mt-4">
                        ...
                        <button onClick={resetFilters} className="px-4 py-2 bg-gray-50 hover:bg-gray-200 text-gray-800 text-sm font-medium rounded-md" 
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 mt-4">
                        ...
                        <select 
                            ...
                            {[...new Set(product.map(item => item.price))].sort((a, b) => a - b).map((price, index) => (
